...
import { FaSave, FaTimes, FaPen, FaListAlt } from 'react-icons/fa';

interface EditarLineaModalProps {
  mostrar: boolean;
  cerrar: () => void;
  nombre: string;
  descripcion: string;
...
export default function EditarLineaModal({
  mostrar,
  cerrar,
  nombre,
  descripcion,
      ...
      >
        ...
        <div className="bg-gradient-to-r from-[#39A900] to-[#2d8500] p-6 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-bold text-white">Editar Línea</h2>
          </div>
          <button
            onClick={cerrar}
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <textarea
                ...
                placeholder="Describe el propósito de esta línea"
              />
            </div>
          </div>
        </div>
