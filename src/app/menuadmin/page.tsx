  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      ...
      >
        <button
          onClick={onClose}
          className={`absolute top-4 right-4 text-2xl font-bold transition-colors ${modoOscuro ? 'text-gray-300 hover:text-red-400' : 'text-gray-500 hover:text-red-500'
            }`}
        >
          ×
        </button>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className={`pl-10 pr-4 py-2 rounded-lg border outline-none transition-all w-64 ${modoOscuro
              ...
              <button
                ...
                className={`p-3 rounded-2xl transition-all duration-500 hover:scale-110 ${modoOscuro
