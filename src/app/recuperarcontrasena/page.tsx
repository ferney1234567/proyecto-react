...
export default function RecuperarContrasena() {
  ...
  const manejarEnvio = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      // Aquí podrías redirigir al usuario o mostrar otro mensaje
    ...
    <div className="min-h-screen w-full flex items-center justify-center p-4 overflow-hidden relative">
      ...
      {mostrandoAlerta && (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 animate-fade-in">
          <div className="bg-white p-10 rounded-xl text-center shadow-lg animate-fade-in-up">
            <div className="w-20 h-20 border-8 border-green-100 border-t-green-500 rounded-full animate-spin mx-auto mb-4"></div>
            <p className="text-xl font-bold text-green-600">ENVIANDO CÓDIGO...</p>
      ...
      <div className="relative z-10 w-full max-w-md bg-white/80 rounded-2xl p-8 shadow-2xl backdrop-blur-md border border-white/30 animate-fade-in-up">
        ...
        <div className="flex flex-col items-center mb-8 animate-fade-in-up" style={{ animationDelay: '100ms' }}>
          ...
          />
          <h1 className="text-3xl font-bold bg-gradient-to-r from-gray-800 to-[#39A900] bg-clip-text text-transparent text-center">
        ...
        <div className="text-center mt-6 animate-fade-in-up" style={{ animationDelay: '400ms' }}>
          <a href="/" className="text-sm font-semibold text-[#39A900] no-underline hover:underline inline-flex items-center gap-2">
            <FaArrowLeft />
